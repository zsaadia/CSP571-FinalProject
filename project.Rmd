...
cat("\n6-MONTH TEST-SET CONFUSION MATRIX\n")
test_preds_6mo <- ifelse(xgb_probs_6mo > optimal_threshold_6mo$threshold, "Yes", "No") %>%
  factor(levels = c("No","Yes"))
print(confusionMatrix(test_preds_6mo, test_6mo$Recession_Lead6))
